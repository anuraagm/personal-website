        ...
        <div className="Work overflow:scroll">
            <div className='Workdone lg:pt-12' id="work" ref={workRef}>
                ...
                {work !== null ? (
                        work.map(element => 
                            <div className='mb-6'>
                                <a href={element.company_link} class="block p-6 border border-gray-200 rounded-sm shadow bg-zinc-800 border-zinc-700 hover:bg-zinc-700">
                    ...
                    {project !== null ? (
                            project.map(element => 
                                <div className='mb-6' id={element.id} onClick={() => manageModal(element)}>
                                    <div class="block p-6 border border-zinc-200 rounded-sm shadow bg-zinc-800 border-zinc-700 hover:bg-zinc-700" id="toggle-card">
